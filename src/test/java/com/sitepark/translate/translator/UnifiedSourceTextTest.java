...
class UnifiedSourceTextTest {
  ...
  void testExpandTranslationOnlyWithDifferentText() {
    ...
    assertArrayEquals(
        translationText, unifiedSourceText.expandTranslation(translationText), "wrong expanded");
  }
  ...
  void testGetSourceTextWithEqualsText() {
    ...
    UnifiedSourceText unifiedSourceText = new UnifiedSourceText(sourceText);
    assertArrayEquals(
        new String[] {"Hallo", "Welt"}, unifiedSourceText.getSourceText(), "should be unified");
  }
  ...
  void testExpandTranslationWithEqualsText() {
    String[] sourceText =
        new String[] {
          "Eins", "Eins", "Zwei", "Eins", "Zwei", "Zwei", "Drei", "Vier", "Fünf", "Zwei", "Fünf",
          "Drei",
        };
    UnifiedSourceText unifiedSourceText = new UnifiedSourceText(sourceText);

    String[] translationText = new String[] {"One", "Two", "Three", "Four", "Five"};
    String[] expectedTranslationText =
        new String[] {
          "One", "One", "Two", "One", "Two", "Two", "Three", "Four", "Five", "Two", "Five", "Three",
        };
