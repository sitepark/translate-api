...
class TranslationProviderConfigurationTest {
  ...
  void testBuilder() {
    ...
    TranslationCache translationCache = Mockito.mock(TranslationCache.class);
    ...
    assertSame(translationCache, config.getTranslationCache().get(), "unexpected translationCache");
    assertSame(
    ...
    assertEquals(true, config.isEncodePlaceholder(), "unexpected encodePlaceholder");
  }
  ...
  void testGetTranslationProviderConfiguration() {
    ...
    assertNotNull(testProviderConfiguration, "expect non null providerConfiguration");
  }
